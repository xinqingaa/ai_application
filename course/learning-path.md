...
完成 V3 后，应能够构建受控的单 Agent RAG：区分运行状态、会话、记忆和业务知识，通过 Tool Schema 与 Tool Runtime 执行动态检索，解释每次继续、完成、追问、失败或安全阻止的原因，并评估工具选择、轨迹、记忆污染、质量、成本和延迟。产品界面能够同步展示 Tool Call、记忆使用、证据变化和停止原因。
