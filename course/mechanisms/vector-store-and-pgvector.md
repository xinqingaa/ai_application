...
>
> 课程位置：[标准学习路径](../learning-path.md) V0 第十二步。第 10 步提供 Embedding、向量和相似度的前置直觉；第 11 步提供同一批资料上的词面检索对照，但不是本节的知识前置。本文解释机制和边界，不承担实验准备、完整命令或运行排障；这些内容见[第 12 步操作文档](../../source/demos/rag_retrieval_lab/docs/12-pgvector-dense.md)。
