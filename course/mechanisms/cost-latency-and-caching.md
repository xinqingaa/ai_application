...
>
> 阅读顺序见[标准学习路径](../learning-path.md)。必要前置是 [Calling Harness](calling-harness-and-regression.md)；本文交付 usage、估算价格、延迟和缓存失效的联合诊断，其中 usage、成本和延迟属于主线，Exact-match Cache 与失效实验属于扩展判断。
