...
>
> - 机制：[Lexical Retrieval、BM25 边界与 PostgreSQL 全文检索](011.lexical-retrieval.mechanism.md)
> - 阅读顺序：[标准学习路径](../learning-path.md)
> - 数据库概念不够时，按需阅读 [PostgreSQL 零基础](prerequisite.postgresql-for-ai-applications.concept.md)
...
| Server / 表 / SQL 这些词仍陌生 | [PostgreSQL 零基础](prerequisite.postgresql-for-ai-applications.concept.md) |
...
然后打开 [机制正文](011.lexical-retrieval.mechanism.md)，从“先用两个 Chunk 预测结果”继续。需要对照命令或输出时再回到本页，不要重装数据库。
