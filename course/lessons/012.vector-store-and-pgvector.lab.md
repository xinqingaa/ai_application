...
>
> - 机制：[pgvector、Dense Retrieval 与向量索引](012.vector-store-and-pgvector.mechanism.md)
> - 表示前置：[Embedding 表示与向量相似度](010.embedding-and-similarity.mechanism.md)
> - 词面对照：[Lexical Retrieval、BM25 边界与 PostgreSQL FTS](011.lexical-retrieval.mechanism.md)
...
完整原理、自然边界和修改题见[机制正文](012.vector-store-and-pgvector.mechanism.md)。
