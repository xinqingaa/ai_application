...
>
> 阅读顺序见[标准学习路径](../learning-path.md)。必要前置是 [LLM 在 AI 应用中的位置与边界](001.llm-in-ai-applications.concept.md)；本文交付 Prompt、Context 与 Schema 的统一契约心智。
...
- [Prompt Engineering](004.prompt-engineering.mechanism.md)
- [Structured Output](005.structured-output.mechanism.md)
- [检索名单怎样变成模型本轮 Context](015.context-engineering.mechanism.md)
