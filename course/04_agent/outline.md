...
`06_ai_native_frontend` 展示多 Agent 过程、工具调用、工作流节点和人工确认。
...
Agent 系统更容易失败：工具选错、参数错、循环、越权、证据不足却强答、多个 Agent 结论冲突。
...
把评估指标交给 `05_eval_observability` 系统化。

## 13. 需求评审多 Agent Workflow 项目
