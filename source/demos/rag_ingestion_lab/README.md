...
| 程序 | 实验篇 |
| --- | --- |
| `inspect_ingestion.py` | [真实文档解析与错误边界](../../../course/lessons/008.document-loading-and-cleaning.lab.md) |
| `inspect_chunking.py` | [Chunk 策略与 Metadata](../../../course/lessons/009.chunking-and-metadata.lab.md) |
