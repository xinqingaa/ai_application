...
> 本文档说明如何跟着 [学习文档](../../../course/python_base/06_class.md) 一步步动手操作
...
```bash
touch source/python_base/06_class/class_basics.py
touch source/python_base/06_class/encapsulation_inheritance.py
touch source/python_base/06_class/dataclass_special.py
```
...
```bash
python source/python_base/06_class/class_basics.py
```
...
```bash
python source/python_base/06_class/encapsulation_inheritance.py
```
...
```bash
python source/python_base/06_class/dataclass_special.py
```
