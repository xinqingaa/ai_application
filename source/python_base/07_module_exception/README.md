...
> 本文档说明如何跟着 [学习文档](../../../course/python_base/07_module_exception.md) 一步步动手操作
...
- 所有操作在 `source/python_base/07_module_exception/` 目录下进行
...
```bash
cd source/python_base/07_module_exception
cp .env.example .env
```
