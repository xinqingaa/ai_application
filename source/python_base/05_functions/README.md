...
> 本文档说明如何跟着 [学习文档](../../../course/python_base/05_functions.md) 一步步动手操作
...
```
source/python_base/05_functions/
├── README.md                 ← 你正在读的这个文件
...
```bash
touch source/python_base/05_functions/function_basics.py
touch source/python_base/05_functions/generators.py
touch source/python_base/05_functions/type_annotations.py
touch source/python_base/05_functions/higher_order.py
```
...
```bash
python source/python_base/05_functions/function_basics.py
```
...
```bash
python source/python_base/05_functions/generators.py
```
...
```bash
python source/python_base/05_functions/type_annotations.py
```
...
```bash
python source/python_base/05_functions/higher_order.py
```
