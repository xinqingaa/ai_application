...
`labs/` 用于存放 `04_rag` 的九个章节快照。

学习时只做两件事：

1. 进入当前章节对应的 `phase_*`
2. 只看当前阶段的 README 和代码

| Phase | 对应正文 | 当前状态 |
|-------|----------|----------|
| `phase_1_scaffold/` | [01_rag_basics.md](/Users/linruiqiang/work/ai_application/docs/04_rag/01_rag_basics.md) | 已实现 |
...
| `phase_9_project_integration/` | [09_rag_project.md](/Users/linruiqiang/work/ai_application/docs/04_rag/09_rag_project.md) | 占位 |

每个 `phase_*/README.md` 都同时承担三件事：

- 告诉你这一章先跑什么命令
- 告诉你代码按什么顺序读
- 告诉你本章新增了什么、还没实现什么、下一章接什么
