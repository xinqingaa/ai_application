...
- [模型 API 与 Provider 抽象](../../../course/lessons/003.model-api-and-provider.mechanism.md)
- [Embedding 表示与向量相似度](../../../course/lessons/010.embedding-and-similarity.mechanism.md)
- [面向应用的 Prompt Engineering](../../../course/lessons/004.prompt-engineering.mechanism.md)
- [Structured Outputs](../../../course/lessons/005.structured-output.mechanism.md)
- [Streaming 与 Conversation 组合机制参考](../../../course/lessons/reference.streaming-and-conversation.mechanism.md)
- [检索名单怎样变成模型本轮 Context](../../../course/lessons/015.context-engineering.mechanism.md)
- [Reliability、Errors 与 Degradation](../../../course/lessons/006.reliability-and-errors.mechanism.md)
- [LLM Calling Harness](../../../course/lessons/029.calling-harness-and-regression.mechanism.md)
- [Cost、Latency 与 Caching](../../../course/lessons/030.cost-latency-and-caching.mechanism.md)
