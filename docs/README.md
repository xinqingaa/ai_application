...
`docs/` 保存长期战略和协作规范，不保存课程正文、产品运行手册、迁移记录或实时进度。

| 文档 | 职责 |
| --- | --- |
| [strategy.md](strategy.md) | 职业定位、唯一项目和两个阶段 |
| [learning-guide.md](learning-guide.md) | 学习方式、四类文档、代码与实验规则 |
| [ai-coding-mastery.md](ai-coding-mastery.md) | 概念、机制、实验、项目掌握和代码所有权 |
