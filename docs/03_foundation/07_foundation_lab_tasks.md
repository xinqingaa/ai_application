...
| 文档部分 | 对应代码/文档 | 角色 | 说明 |
|----------|---------------|------|------|
| 本章全文 | 本文档 | 第一执行入口 | 固定实施顺序和完成标准 |
| `3-8` Phase 清单 | `foundation_lab/app/`、`scripts/`、`tests/` | 分阶段落地清单 | 明确每一步先写什么、后写什么 |
| `8. 接口与工程化收口` | `main.py`、`logger.py`、项目 README、测试目录 | 收口阶段 | 说明什么时候才补接口和 README |
